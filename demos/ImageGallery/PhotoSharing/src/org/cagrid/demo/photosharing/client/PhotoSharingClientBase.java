 ...
 */
public abstract class PhotoSharingClientBase extends ServiceSecurityClient {	
	protected PhotoSharingPortType portType;
	...
	public PhotoSharingClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public PhotoSharingClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
