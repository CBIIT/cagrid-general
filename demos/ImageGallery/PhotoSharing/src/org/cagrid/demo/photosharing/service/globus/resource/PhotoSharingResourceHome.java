 ...
 * 
 */
public class PhotoSharingResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(PhotoSharingResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		PhotoSharingResource resource = (PhotoSharingResource) super.find(key);
		return resource;
	}
