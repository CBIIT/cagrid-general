 ...
 * 
 */
public class GalleryResourceHome extends ResourceHomeImpl {
 	...
 	*/	
	public GalleryResource getResource(ResourceKey key) throws ResourceException {
		GalleryResource thisResource = (GalleryResource)find(key);
		return thisResource;
	}
