 ...
 */
public abstract class GalleryClientBase extends ServiceSecurityClient {	
	protected GalleryPortType portType;
	...
	public GalleryClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public GalleryClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
