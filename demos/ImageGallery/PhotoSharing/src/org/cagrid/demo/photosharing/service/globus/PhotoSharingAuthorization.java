 ...
 * 
 */
public class PhotoSharingAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://photosharing.demo.cagrid.org/PhotoSharing";
	
	Map authorizationClassMap = new HashMap();
	
	
	public PhotoSharingAuthorization() {
	}
	...
	public void authorizeCreateGallery(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeListGalleries(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("createGallery")){
			authorizeCreateGallery(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("listGalleries")){
			authorizeListGalleries(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
