 ...
 * 
 */
public class PhotoSharingRegistrationResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(PhotoSharingRegistrationResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		PhotoSharingRegistrationResource resource = (PhotoSharingRegistrationResource) super.find(key);
		return resource;
	}
