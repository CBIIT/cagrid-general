...
import org.cagrid.demos.photoservicereg.common.PhotoSharingRegistrationConstants;
import org.cagrid.demos.photoservicereg.stubs.PhotoSharingRegistrationResourceProperties;
import org.cagrid.demos.photoservicereg.service.PhotoSharingRegistrationConfiguration;
import java.io.File;
 ...
 * 
 */
public abstract class PhotoSharingRegistrationResourceBase extends ReflectionResource implements Resource
                                                  {

	static final Log logger = LogFactory.getLog(PhotoSharingRegistrationResourceBase.class);

	private PhotoSharingRegistrationResourceConfiguration configuration;
    ...
    public PhotoSharingRegistrationResourceBase() {
    }
	...
	public PhotoSharingRegistrationResourceConfiguration getConfiguration() {
		...
		servicePath+="/PhotoSharingRegistration";
		...
		try {
			...
			this.configuration = (PhotoSharingRegistrationResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
