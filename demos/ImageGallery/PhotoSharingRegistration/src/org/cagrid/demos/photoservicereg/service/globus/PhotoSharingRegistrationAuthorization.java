 ...
 * 
 */
public class PhotoSharingRegistrationAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://photoservicereg.demos.cagrid.org/PhotoSharingRegistration";
	
	Map authorizationClassMap = new HashMap();
	
	
	public PhotoSharingRegistrationAuthorization() {
	}
	...
	public void authorizeRegisterPhotoSharingService(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeUnregisterPhotoSharingService(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("getMultipleResourceProperties")){
			...
			return true;
		} else if(operation.getLocalPart().equals("registerPhotoSharingService")){
			authorizeRegisterPhotoSharingService(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("unregisterPhotoSharingService")){
			authorizeUnregisterPhotoSharingService(peerSubject, context, operation);
			return true;
		} 		
		return false;
	}
