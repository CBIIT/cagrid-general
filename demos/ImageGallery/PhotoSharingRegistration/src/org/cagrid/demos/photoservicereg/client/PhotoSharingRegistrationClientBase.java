 ...
 */
public abstract class PhotoSharingRegistrationClientBase extends ServiceSecurityClient {	
	protected PhotoSharingRegistrationPortType portType;
	...
	public PhotoSharingRegistrationClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public PhotoSharingRegistrationClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
