 ...
 */
public abstract class StockPortfolioManagerClientBase extends ServiceSecurityClient implements NotifyCallback {	
	protected StockPortfolioManagerPortType portType;
	...
	public StockPortfolioManagerClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public StockPortfolioManagerClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
