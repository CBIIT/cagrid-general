 ...
 * 
 */
public class StockManagerResourceHome extends SingletonResourceHomeImpl implements Initializable {

	static final Log logger = LogFactory.getLog(StockManagerResourceHome.class);
	...
	public Resource find(ResourceKey key) throws ResourceException {
		StockManagerResource resource = (StockManagerResource) super.find(key);
		return resource;
	}
