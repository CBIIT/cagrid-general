 ...
 * 
 */
public class StockPortfolioManagerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://stockmanager.tutorial.introduce.cagrid.org/StockManager/Portfolio";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StockPortfolioManagerAuthorization() {
	}
	...
	public void authorizeAddStock(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetPortfolioQuote(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public void authorizeEnumerateStocks(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
	...
	public boolean isPermitted(Subject peerSubject, MessageContext context, QName operation)
		...
		if(operation.getLocalPart().equals("addStock")){
			authorizeAddStock(peerSubject, context, operation);
			return true;
		} else if(operation.getLocalPart().equals("getPortfolioQuote")){
			authorizeGetPortfolioQuote(peerSubject, context, operation);
			return true;
			...
			return true;
		} else if(operation.getLocalPart().equals("enumerateStocks")){
			authorizeEnumerateStocks(peerSubject, context, operation);
			return true;
