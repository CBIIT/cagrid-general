 ...
 * 
 */
public abstract class StockPortfolioManagerResourceBase extends ReflectionResource implements Resource
                                                  ,PersistenceCallback
                                                  ,TopicListAccessor
                                                  ,RemoveCallback
                                                  {

	static final Log logger = LogFactory.getLog(StockPortfolioManagerResourceBase.class);

	private StockPortfolioManagerResourceConfiguration configuration;
    ...
    public StockPortfolioManagerResourceBase() {
        try {
            resourcePropertyPersistenceHelper = new gov.nih.nci.cagrid.introduce.servicetools.XmlPersistenceHelper(StockPortfolioManagerResourceProperties.class,StockManagerConfiguration.getConfiguration());
            resourcePersistenceHelper = new FilePersistenceHelper(this.getClass(),StockManagerConfiguration.getConfiguration(),".resource");
        } catch (Exception ex) {
	...
	public void setTerminationTime(Calendar time) {
		...
		Topic terminationTopic = ((Topic)getResourcePropertySet().get(StockPortfolioManagerConstants.TERMINATIONTIME));
	...
	public org.cagrid.introduce.tutorial.tools.beans.Portfolio getPortfolio(){
		return ((StockPortfolioManagerResourceProperties) getResourceBean()).getPortfolio();
	}
	
	public void setPortfolio(org.cagrid.introduce.tutorial.tools.beans.Portfolio portfolio ) throws ResourceException {
        ResourceProperty prop = getResourcePropertySet().get(StockPortfolioManagerConstants.PORTFOLIO);
		prop.set(0, portfolio);
        //call the first store to persist the resource
        store();
	}
	...
	public StockPortfolioManagerResourceConfiguration getConfiguration() {
		...
		servicePath+="/StockPortfolioManager";
		...
		try {
			...
			this.configuration = (StockPortfolioManagerResourceConfiguration) initialContext.lookup(jndiName);
		} catch (Exception e) {
