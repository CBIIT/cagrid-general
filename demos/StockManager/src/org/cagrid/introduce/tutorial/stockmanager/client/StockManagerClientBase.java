 ...
 */
public abstract class StockManagerClientBase extends ServiceSecurityClient {	
	protected StockManagerPortType portType;
	...
	public StockManagerClientBase(String url, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(url,proxy);
	   	initialize();
	}
	
	public StockManagerClientBase(EndpointReferenceType epr, GlobusCredential proxy) throws MalformedURIException, RemoteException {
	   	super(epr,proxy);
		initialize();
	}
