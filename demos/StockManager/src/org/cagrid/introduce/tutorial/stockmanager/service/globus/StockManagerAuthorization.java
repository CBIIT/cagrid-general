 ...
 * 
 */
public class StockManagerAuthorization implements PDP {

	public static final String SERVICE_NAMESPACE = "http://stockmanager.tutorial.introduce.cagrid.org/StockManager";
	
	Map authorizationClassMap = new HashMap();
	
	
	public StockManagerAuthorization() {
	}
	...
	public void authorizeGetQuote(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeGetChart(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
		
	}
	   				
	public void authorizeCreatePortfolio(Subject peerSubject, MessageContext context, QName operation) throws AuthorizationException {
